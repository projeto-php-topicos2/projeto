<?php 
    ...
    if(isset($data)){
      ...
      try{
        ...
        $query = $con->query("SELECT * FROM fornecedores WHERE id = $id");
    ...
    <div class="formbox">
      ...
      <form action="<?= URL_BASE . $rota ?>" method="post">
        ...
        <div class="col-6">
            ...
            <input id="razao" class="form-control" type="text" name="razao_social" value= "<?=  $registro['razao_social'] ?>"placeholder="">
          </div>
          <div class="form-group">
            <label for="cnpj">CNPJ</label>
            <input id="cnpj" class="form-control" type="text" name="cnpj" value= "<?= $registro['cnpj'] ?>" placeholder="111.222.333-00">
          </div>
          <div class="form-group">
